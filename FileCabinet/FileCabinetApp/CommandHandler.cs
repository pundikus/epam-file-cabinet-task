...
namespace FileCabinetApp
{
    ...
    public class CommandHandler : CommandHandlerBase
    {
        ...
        private static void Create(string parameters)
        {
            do
            {
                try
                {
                    ...
                    int record = Program.FileCabinetService.CreateRecord(parametrs);
        ...
        private static void Import(string parametrs)
        {
            ...
            var snapshot = new FileCabinetServiceSnapshot(Program.FileCabinetService.GetRecords());
        ...
        {
            int countRecords = Program.FileCabinetService.GetRecords().Count;
            int countRemovedRecords = 0;
            if (IsStorageFile)
            {
                countRemovedRecords = Program.FileCabinetService.PurgeRecords();
