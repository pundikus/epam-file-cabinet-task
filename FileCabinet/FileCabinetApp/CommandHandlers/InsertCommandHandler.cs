...
namespace FileCabinetApp
{
    ...
    public class InsertCommandHandler : ServiceCommandHandlerBase
    {
        ...
        public override object Handle(AppCommandRequest request)
        {
            ...
            if (request.Command.ToLower(CultureInfo.InvariantCulture) == "insert")
            {
        ...
        private void Insert(string parameters)
        {
            ...
            {
                if (args[i].ToLower(CultureInfo.InvariantCulture).Contains("values", StringComparison.InvariantCulture) || args[i].ToLower(CultureInfo.InvariantCulture).Contains("value", StringComparison.InvariantCulture))
                {
                    valueIndex = i;
                    break;
                }
